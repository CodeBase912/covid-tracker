...
export function updateCovidDataContainer(dataContainerVaccinationData, countryCodeData) {
    ...
    */
    ...
    if (covidDataType == "Cases") {
        ...
        const deathsDataContainer = covidDataContainer.querySelector("#data-container-3");
        ...
        if (location == "worldwide") {
            ...
            xhr.onload = function() {
                if (this.status == 200) {
                    ...
                    casesDataContainer.querySelector(".data-container-title").innerHTML = "Cases";
                    recoveriesDataContainer.querySelector(".data-container-title").innerHTML = "Recoveries";
                    deathsDataContainer.querySelector(".data-container-title").innerHTML = "Deaths";

                    // Set Data Container Info-1 titles and data
                    casesDataContainer.querySelector(".data-container-info-1").querySelector(".data-info-title").innerHTML = "New";
                    casesDataContainer.querySelector(".data-container-info-1").querySelector(".data-info-data").innerHTML = formatNumber(data.todayCases);
                    recoveriesDataContainer.querySelector(".data-container-info-1").querySelector(".data-info-title").innerHTML = "New";
                    recoveriesDataContainer.querySelector(".data-container-info-1").querySelector(".data-info-data").innerHTML = formatNumber(data.todayRecovered);
                    deathsDataContainer.querySelector(".data-container-info-1").querySelector(".data-info-title").innerHTML = "New";
                    deathsDataContainer.querySelector(".data-container-info-1").querySelector(".data-info-data").innerHTML = formatNumber(data.todayDeaths);

                    // Set Data Container Info-2 titles and data
                    casesDataContainer.querySelector(".data-container-info-2").querySelector(".data-info-title").innerHTML = "Total";
                    casesDataContainer.querySelector(".data-container-info-2").querySelector(".data-info-data").innerHTML = formatNumber(data.cases);
                    recoveriesDataContainer.querySelector(".data-container-info-2").querySelector(".data-info-title").innerHTML = "Total";
                    recoveriesDataContainer.querySelector(".data-container-info-2").querySelector(".data-info-data").innerHTML = formatNumber(data.recovered);
                    deathsDataContainer.querySelector(".data-container-info-2").querySelector(".data-info-title").innerHTML = "Total";
                    deathsDataContainer.querySelector(".data-container-info-2").querySelector(".data-info-data").innerHTML = formatNumber(data.deaths);
                }
            }
            ...
            const xhr = new XMLHttpRequest();
            xhr.open("GET", `https://disease.sh/v3/covid-19/countries/${location}?strict=true`, true);
            let data;
            xhr.onload = function() {
                if (this.status == 200) {
                    data = JSON.parse(this.responseText);
        ...
        casesDataContainer.querySelector(".data-container-title").innerHTML = "Vaccinations";
        casesDataContainer.querySelector(".data-container-info-1").querySelector(".data-info-title").innerHTML = "Today";

        recoveriesDataContainer.querySelector(".data-container-title").innerHTML = "Stats";
        recoveriesDataContainer.querySelector(".data-container-info-1").querySelector(".data-info-title").innerHTML = "Average (vaccinations per day)";
        recoveriesDataContainer.querySelector(".data-container-info-2").querySelector(".data-info-title").innerHTML = "Vaccination Rate (%)";
        ...
        if (location == "worldwide") {
            ...
            */
            ...
            if (dataContainerVaccinationData) {
                ...
                const countryVaccinationData = dataContainerVaccinationData.find(function(country) {
                ...
                let vaccinationRate = (countryVaccinationData.timeline[0].total / countryData.population).toPrecision(4) * 100;
                ...
                */
                ...
                casesDataContainer.querySelector(".data-container-info-1").querySelector(".data-info-data").innerHTML = formatNumber(todaysVaccinations);
                casesDataContainer.querySelector(".data-container-info-2").querySelector(".data-info-data").innerHTML = formatNumber(totalVaccinations);

                // recoveriesDataContainer.querySelector(".data-container-info-1").querySelector(".data-info-data").innerHTML = todaysVaccinations;
                recoveriesDataContainer.querySelector(".data-container-info-2").querySelector(".data-info-data").innerHTML = vaccinationRate+"%";
            }
            else {
                // Format of countryData = {country: "South Africa", countryCode: "ZA"}
                const countryData = countryCodeData.find(function(country) {
